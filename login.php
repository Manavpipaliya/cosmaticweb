                                        ...
                                        <tr>
                                            <td class="product-image">
                                                <a href="./productdetails.php">
                                                    <img src="C:\xampp\htdocs\CosmeticShop\image_cosmatic\36.jpg" alt="Product">
                                                </a>
                                            </td>
                                            <td>
                                                <div class="product-name">
                                                    <a href="./productdetails.php">MACS</a>
                                                </div>
                                                <div>
                                                    2 x
                    ...
                    <div class="col-sm-5 col-md-5 align-items-center justify-content-center navbar-expand-md main-menu">
                        <div class="menu navbar collapse navbar-collapse">
                            <ul class="menu-top navbar-nav">
                                ...
                                <li>
                                    <a href="./productdetails.php" class="parent">Product</a>
                                    <div class="dropdown-menu">
                ...
                <div id="main">
                    <div class="container">
                        ...
                        <div class="login-form">
                            <form id="customer-form" action="./productlist.php" method="post">
                                <div>
                                    ...
                                    <div class="form-group no-gutters">
                                        <div class="input-group js-parent-focus">
                                            <input class="form-control js-child-focus js-visible-password" required name="password" type="password" value="" placeholder="Password">
                                        </div>
                                    </div>
                                    <div class="no-gutters text-center">
                                        <div class="forgot-password">
                                            <a href="./reset_password.php" rel="nofollow">
