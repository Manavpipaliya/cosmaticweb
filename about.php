								...
								<div class="about-us-content">
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 right">
											<a href="#">
												<img class="img-fluid" src=".\image_cosmatic\28.jpg" alt="#" />
											</a>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 left">
											<div class="cms-block f-right">
												<h3 class="page-subheading">Skin care</h3>
												<p>We want to empower you to be effectivly support your skin in a healthy way that's in alignment with the truth you are beautiful as your are</p>
												
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 right">
											<div class="cms-block f-left">
												<h3 class="page-subheading">Beauty</h3>
												<p>our makeup and skincare products for all types of skin are used and offered in more than  beauty institutes in Belgin</p>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 left">
											<a href="#">
												<img class="img-fluid" src=".\image_cosmatic\2.jpg" alt="#" />
											</a>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 right">
											<a href="#">
												<img class="img-fluid" src=".\image_cosmatic\6.jpg" alt="#" />
											</a>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 left">
											<div class="cms-block f-right">
												<h3 class="page-subheading no-before">Quantity</h3>
												<p>
                                                    Lisine offers beauty product and high quatity cares for all skin type,for women.This concern for quality begins with the choice of high quality ingredients and continues during production and packaging
                                                </p>
