                    ...
                    <div class="col-sm-5 col-md-5 align-items-center justify-content-center navbar-expand-md main-menu">
                        <div class="menu navbar collapse navbar-collapse">
                            <ul class="menu-top navbar-nav">
                                ...
                                <li>
                                    <a href="./image_cosmatic/38.jpg" class="parent">Product</a>
                                                    ...
                                                    <div class="product-line-grid row justify-content-between">
                                                        ...
                                                        <div class="product-line-grid-left col-md-2">
                                                            <span class="product-image media-middle">
                                                                <a href="./productdetails.php">
                                                                    <img class="img-fluid" src=".\image_cosmatic\21.jpg" alt="">
                                                                </a>
                                                            </span>
                                                        </div>
                                                        <div class="product-line-grid-body col-md-6">
                                                            <div class="product-line-info">
                                                                <a class="label" href="./productdetails.php" data-id_customization="0">Lipstics</a>
                                                            </div>
                                                ...
                                                <li class="cart-item">
                                                    <div class="product-line-grid row justify-content-between">
                                                        ...
                                                        <div class="product-line-grid-left col-md-2">
                                                            <span class="product-image media-middle">
                                                                <a href="product-detail.html">
                                                                    <img class="img-fluid" src=".\image_cosmatic\27.jpg" alt="Organic Strawberry Fruits">
                                                                </a>
                                                            </span>
                                                        </div>
                                                        <div class="product-line-grid-body col-md-6">
                                                            <div class="product-line-info">
                                                                <a class="label" href="./productdetails.php" data-id_customization="0">
                                                                    Kajal</a>
                                                            </div>
                                                            <div class="product-line-info product-price">
                                                ...
                                                <li class="cart-item">
                                                    <div class="product-line-grid row justify-content-between">
                                                        ...
                                                        <div class="product-line-grid-left col-md-2">
                                                            <span class="product-image media-middle">
                                                                <a href="./productdetails.php">
                                                                    <img class="img-fluid" src=".\image_cosmatic\4.jpg" alt="Organic Strawberry Fruits">
                                                                </a>
                                                            </span>
                                                        </div>
                                                        <div class="product-line-grid-body col-md-6">
                                                            <div class="product-line-info">
                                                                <a class="label" href="product-detail.html" data-id_customization="0">Mascra</a>
                                                            </div>
                                                            <div class="product-line-info product-price">
