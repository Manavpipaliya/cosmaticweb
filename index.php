                                        ...
                                        <tr>
                                            <td class="product-image">
                                                <a href="product-detail.html">
                                                    <img src="./image_cosmatic/18.jpg" alt="Product">
                                                </a>
                                            </td>
                                            <td>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-2 col-md-2 d-flex align-items-center">
                        <div id="logo">
                            <a href="index-2.html">
                                <img class="img-fluid" src="./image_cosmatic/38.jpg" alt="logo">
                            </a>
                        </div>
                    </div>
                                                        ...
                                                        <li class="item col-md-4 float-left">
                                                            ...
                                                            <div class="menu-content">
                                                                <ul class="col">
                                                                        ...
                                                                        <a href="C:\xampp\htdocs\CosmeticShop\productdetails.php"></a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </li>
                        ...
                        <div id="block_myaccount_infos" class="hidden-sm-down dropdown">
                            ...
                            <div id="acount" class="collapse">
                                <div class="account-list-content">
                                    ...
                                    <div>
                                        <a class="userwislidt" href="./userwislist.php" title="My Wishlists">
                                    ...
                                    <div id="desktop_language_selector" class="language-selector groups-selector hidden-sm-down">
                                        <ul class="list-inline">
                                            <li class="list-inline-item current">
                                                <a href="#">
                                                    <img class="img-fluid" src="./image_cosmatic/1.jpg" alt="English" width="16" height="11">
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="#">
                                                    <img class="img-fluid" src="./image_cosmatic/10.jpg" alt="Italiano" width="16" height="11">
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="#">
                                                    <img class="img-fluid" src="./image_cosmatic/35.jpg" alt="Français" width="16" height="11">
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="#">
                                                    <img class="img-fluid" src="./image_cosmatic/44.jpg" alt="Español" width="16" height="11">
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="cart-content">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td class="product-image">
                                                        <a href="C:\xampp\htdocs\CosmeticShop\productdetails.php">
                                                            <img src="./image_cosmatic/18.jpg" alt="Product">
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <div class="C:\xampp\htdocs\CosmeticShop\productdetails.php">
                                                            <a href="product-detail.html"></a>
                                                        </div>
                                                        <div>
                                                            2 x
            ...
            <div class="section banner">
                <div class="tiva-slideshow-wrapper">
                    <div id="tiva-slideshow" class="nivoSlider">
                        <a href="#">
                            <img class="img-responsive" src="./image_cosmatic/12.jpg" title="#caption1" alt="Slideshow image">
                        </a>
                        <a href="#">
                            <img class="img-responsive" src="./image_cosmatic/32.jpg" title="#caption2" alt="Slideshow image">
                        </a>
                        <a href="#">
                            <img class="img-responsive" src="./image_cosmatic/35.jpg" title="#caption3" alt="Slideshow image">
                        </a>
                    </div>
                </div>
            </div>
